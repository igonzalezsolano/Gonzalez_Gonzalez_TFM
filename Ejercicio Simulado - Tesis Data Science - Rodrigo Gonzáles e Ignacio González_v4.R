...
generar_dgp <- function(escenario, n = n) {
  ...
  u <- rnorm(n, mean = 0, sd = 0.4) # determinamos el error de la asignación al tratamiento para que no sea algo determinativo perfecto y lo definimos como un error normal
...
# Función para entrenar un modelo rf para las funciones auxiliares
...
df_DR_rf <- function(df, escenario) {
  ...
  theta_hat <- mean(dr_obs_rf, na.rm = TRUE)
  
  # Desvío estándar y error estándar
  sd <- sd(dr_obs_rf, na.rm = TRUE)
  se <- sd / sqrt(nrow(df))
...
getwd()
# Exportamos las simulaciones
#write.xlsx(simulaciones_dr_esc1, "simulaciones_dr_esc1_1000casos.xlsx")
#write.xlsx(simulaciones_dr_esc2, "simulaciones_dr_esc2_1000casos.xlsx")
#write.xlsx(simulaciones_dr_esc3, "simulaciones_dr_esc3_1000casos.xlsx")
#write.xlsx(simulaciones_dr_esc4, "simulaciones_dr_esc4_1000casos.xlsx")
...
getwd()
# Exportamos las simulaciones
#write.xlsx(simulaciones_rf_esc1, "simulaciones_dr_rf_esc1_1000casos.xlsx")
#write.xlsx(simulaciones_rf_esc2, "simulaciones_dr_rf_esc2_1000casos.xlsx")
#write.xlsx(simulaciones_rf_esc3, "simulaciones_dr_rf_esc3_1000casos.xlsx")
#write.xlsx(simulaciones_rf_esc4, "simulaciones_dr_rf_esc4_1000casos.xlsx")
...
resumen_dr_esc1 <- resumen_simulaciones(simulaciones_dr_esc1, theta_0)
...
# Escenario 1
simulaciones_DML_nbase10_1000reps <- simulaciones_dml(1, 10, 1000)
simulaciones_DML_nbase50_1000reps <- simulaciones_dml(1, 50, 1000)
simulaciones_DML_nbase100_1000reps <- simulaciones_dml(1, 100, 1000)
simulaciones_DML_nbase500_1000reps <- simulaciones_dml(1, 500, 1000)
simulaciones_DML_nbase1000_1000reps <- simulaciones_dml(1, 1000, 1000)
simulaciones_DML_nbase5000_1000reps <- simulaciones_dml(1, 5000, 1000)
simulaciones_DML_nbase10000_1000reps <- simulaciones_dml(1, 10000, 1000)

# Escenario 2
simulaciones_DML_nbase10_1000reps_esc2 <- simulaciones_dml(2, 10, 1000)
simulaciones_DML_nbase50_1000reps_esc2 <- simulaciones_dml(2, 50, 1000)
simulaciones_DML_nbase100_1000reps_esc2 <- simulaciones_dml(2, 100, 1000)
simulaciones_DML_nbase500_1000reps_esc2 <- simulaciones_dml(2, 500, 1000)
simulaciones_DML_nbase1000_1000reps_esc2 <- simulaciones_dml(2, 1000, 1000)
simulaciones_DML_nbase5000_1000reps_esc2 <- simulaciones_dml(2, 5000, 1000)
simulaciones_DML_nbase10000_1000reps_esc2 <- simulaciones_dml(2, 10000, 1000)

# Escenario 3
simulaciones_DML_nbase10_1000reps_esc3 <- simulaciones_dml(3, 10, 1000)
simulaciones_DML_nbase50_1000reps_esc3 <- simulaciones_dml(3, 50, 1000)
simulaciones_DML_nbase100_1000reps_esc3 <- simulaciones_dml(3, 100, 1000)
simulaciones_DML_nbase500_1000reps_esc3 <- simulaciones_dml(3, 500, 1000)
simulaciones_DML_nbase1000_1000reps_esc3 <- simulaciones_dml(3, 1000, 1000)
simulaciones_DML_nbase5000_1000reps_esc3 <- simulaciones_dml(3, 5000, 1000)
simulaciones_DML_nbase10000_1000reps_esc3 <- simulaciones_dml(3, 10000, 1000)

# Escenario 4
simulaciones_DML_nbase10_1000reps_esc4 <- simulaciones_dml(4, 10, 1000)
simulaciones_DML_nbase50_1000reps_esc4 <- simulaciones_dml(4, 50, 1000)
simulaciones_DML_nbase100_1000reps_esc4 <- simulaciones_dml(4, 100, 1000)
simulaciones_DML_nbase500_1000reps_esc4 <- simulaciones_dml(4, 500, 1000)
simulaciones_DML_nbase1000_1000reps_esc4 <- simulaciones_dml(4, 1000, 1000)
simulaciones_DML_nbase5000_1000reps_esc4 <- simulaciones_dml(4, 5000, 1000)
simulaciones_DML_nbase10000_1000reps_esc4 <- simulaciones_dml(4, 10000, 1000)

getwd()
# Exportamos las simulaciones
# write.xlsx(simulaciones_DML_nbase10_1000reps, "simulaciones_DML_nbase10_1000reps.xlsx")
# write.xlsx(simulaciones_DML_nbase50_1000reps, "simulaciones_DML_nbase50_1000reps.xlsx")
# write.xlsx(simulaciones_DML_nbase100_1000reps, "simulaciones_DML_nbase100_1000reps.xlsx")
# write.xlsx(simulaciones_DML_nbase500_1000reps, "simulaciones_DML_nbase500_1000reps.xlsx")
# write.xlsx(simulaciones_DML_nbase1000_1000reps, "simulaciones_DML_nbase1000_1000reps.xlsx")
# write.xlsx(simulaciones_DML_nbase10000_1000reps, "simulaciones_DML_nbase10000_1000reps.xlsx")            
# 
# write.xlsx(simulaciones_DML_nbase10_1000reps_esc2, "simulaciones_DML_nbase10_1000reps_esc2.xlsx")
# write.xlsx(simulaciones_DML_nbase50_1000reps_esc2, "simulaciones_DML_nbase50_1000reps_esc2.xlsx")
# write.xlsx(simulaciones_DML_nbase100_1000reps_esc2, "simulaciones_DML_nbase100_1000reps_esc2.xlsx")
# write.xlsx(simulaciones_DML_nbase500_1000reps_esc2, "simulaciones_DML_nbase500_1000reps_esc2.xlsx")
# write.xlsx(simulaciones_DML_nbase1000_1000reps_esc2, "simulaciones_DML_nbase1000_1000reps_esc2.xlsx")
# write.xlsx(simulaciones_DML_nbase10000_1000reps_esc2, "simulaciones_DML_nbase10000_1000reps_esc2.xlsx")            
# 
# write.xlsx(simulaciones_DML_nbase10_1000reps_esc3, "simulaciones_DML_nbase10_1000reps_esc3.xlsx")
# write.xlsx(simulaciones_DML_nbase50_1000reps_esc3, "simulaciones_DML_nbase50_1000reps_esc3.xlsx")
# write.xlsx(simulaciones_DML_nbase100_1000reps_esc3, "simulaciones_DML_nbase100_1000reps_esc3.xlsx")
# write.xlsx(simulaciones_DML_nbase500_1000reps_esc3, "simulaciones_DML_nbase500_1000reps_esc3.xlsx")
# write.xlsx(simulaciones_DML_nbase1000_1000reps_esc3, "simulaciones_DML_nbase1000_1000reps_esc3.xlsx")
# write.xlsx(simulaciones_DML_nbase10000_1000reps_esc3, "simulaciones_DML_nbase10000_1000reps_esc3.xlsx")            
# 
# write.xlsx(simulaciones_DML_nbase10_1000reps_esc4, "simulaciones_DML_nbase10_1000reps_esc4.xlsx")
# write.xlsx(simulaciones_DML_nbase50_1000reps_esc4, "simulaciones_DML_nbase50_1000reps_esc4.xlsx")
# write.xlsx(simulaciones_DML_nbase100_1000reps_esc4, "simulaciones_DML_nbase100_1000reps_esc4.xlsx")
# write.xlsx(simulaciones_DML_nbase500_1000reps_esc4, "simulaciones_DML_nbase500_1000reps_esc4.xlsx")
# write.xlsx(simulaciones_DML_nbase1000_1000reps_esc4, "simulaciones_DML_nbase1000_1000reps_esc4.xlsx")
# write.xlsx(simulaciones_DML_nbase10000_1000reps_esc4, "simulaciones_DML_nbase10000_1000reps_esc4.xlsx")            


mean(simulaciones_DML_nbase10_1000reps$theta)
mean(simulaciones_DML_nbase50_1000reps$theta)
mean(simulaciones_DML_nbase100_1000reps$theta)                    
mean(simulaciones_DML_nbase500_1000reps$theta)
mean(simulaciones_DML_nbase1000_1000reps$theta)
mean(simulaciones_DML_nbase10000_1000reps$theta)
...
library(readxl)
# Escenario 1
simulaciones_DML_nbase10_1000reps <- read_excel("simulaciones_DML_nbase10_1000reps.xlsx")
simulaciones_DML_nbase50_1000reps <- read_excel("simulaciones_DML_nbase50_1000reps.xlsx")
simulaciones_DML_nbase100_1000reps <- read_excel("simulaciones_DML_nbase100_1000reps.xlsx")
simulaciones_DML_nbase500_1000reps <- read_excel("simulaciones_DML_nbase500_1000reps.xlsx")
simulaciones_DML_nbase1000_1000reps <- read_excel("simulaciones_DML_nbase1000_1000reps.xlsx")
simulaciones_DML_nbase5000_1000reps <- read_excel("simulaciones_DML_nbase5000_1000reps.xlsx")
simulaciones_DML_nbase10000_1000reps <- read_excel("simulaciones_DML_nbase10000_1000reps.xlsx")

# Escenario 2
simulaciones_DML_nbase10_1000reps_esc2 <- read_excel("simulaciones_DML_nbase10_1000reps_esc2.xlsx")
simulaciones_DML_nbase50_1000reps_esc2 <- read_excel("simulaciones_DML_nbase50_1000reps_esc2.xlsx")
simulaciones_DML_nbase100_1000reps_esc2 <- read_excel("simulaciones_DML_nbase100_1000reps_esc2.xlsx")
simulaciones_DML_nbase500_1000reps_esc2 <- read_excel("simulaciones_DML_nbase500_1000reps_esc2.xlsx")
simulaciones_DML_nbase1000_1000reps_esc2 <- read_excel("simulaciones_DML_nbase1000_1000reps_esc2.xlsx")
simulaciones_DML_nbase10000_1000reps_esc2 <- read_excel("simulaciones_DML_nbase10000_1000reps_esc2.xlsx")

# Escenario 3
simulaciones_DML_nbase10_1000reps_esc3 <- read_excel("simulaciones_DML_nbase10_1000reps_esc3.xlsx")
simulaciones_DML_nbase50_1000reps_esc3 <- read_excel("simulaciones_DML_nbase50_1000reps_esc3.xlsx")
simulaciones_DML_nbase100_1000reps_esc3 <- read_excel("simulaciones_DML_nbase100_1000reps_esc3.xlsx")
simulaciones_DML_nbase500_1000reps_esc3 <- read_excel("simulaciones_DML_nbase500_1000reps_esc3.xlsx")
simulaciones_DML_nbase1000_1000reps_esc3 <- read_excel("simulaciones_DML_nbase1000_1000reps_esc3.xlsx")
simulaciones_DML_nbase10000_1000reps_esc3 <- read_excel("simulaciones_DML_nbase10000_1000reps_esc3.xlsx")

# Escenario 4
simulaciones_DML_nbase10_1000reps_esc4 <- read_excel("simulaciones_DML_nbase10_1000reps_esc4.xlsx")
simulaciones_DML_nbase50_1000reps_esc4 <- read_excel("simulaciones_DML_nbase50_1000reps_esc4.xlsx")
simulaciones_DML_nbase100_1000reps_esc4 <- read_excel("simulaciones_DML_nbase100_1000reps_esc4.xlsx")
simulaciones_DML_nbase500_1000reps_esc4 <- read_excel("simulaciones_DML_nbase500_1000reps_esc4.xlsx")
simulaciones_DML_nbase1000_1000reps_esc4 <- read_excel("simulaciones_DML_nbase1000_1000reps_esc4.xlsx")
simulaciones_DML_nbase10000_1000reps_esc4 <- read_excel("simulaciones_DML_nbase10000_1000reps_esc4.xlsx")
...
boxplot_escenario1 <- ggplot(simulaciones_todas, aes(x = factor(n), y = theta)) +
  ...
  labs(x = "n", y = expression(hat(theta)),
       title = "Escenario 1: g(x) no lineal y p(x) no logística") +
...
boxplot_escenario2 <- ggplot(simulaciones_esc2, aes(x = factor(n), y = theta)) +
  ...
  labs(
    ...
    title = "Escenario 2: g(x) lineal y p(x) no es logística"
  ) +
  theme_minimal(base_size = 13) +
  theme(
    axis.title.y = element_text(angle = 0, vjust = 0.5)
...
boxplot_escenario3 <- ggplot(simulaciones_esc3, aes(x = factor(n), y = theta)) +
  ...
  labs(
    x = "n",
    y = expression(hat(theta)),
    title = "Escenario 3: g(x) no lineal y p(x) logistica"
  ) +
  theme_minimal(base_size = 13) +
  theme(
    axis.title.y = element_text(angle = 0, vjust = 0.5)
...
boxplot_escenario4 <- ggplot(simulaciones_esc4, aes(x = factor(n), y = theta)) +
  ...
  labs(
    x = "n",
    y = expression(hat(theta)),
    title = "Escenario 4: g(x) lineal y p(x) logistica"
  ) +
  theme_minimal(base_size = 13) +
  theme(
    axis.title.y = element_text(angle = 0, vjust = 0.5)
...
####### Tablas con percentiles por escenario y n ########

# Función para obtener los percentiles de las simulaciones
tabla_cuantiles <- function(df, columna = "theta") {
  probs <- seq(0.1, 0.9, by = 0.1)
  valores <- quantile(df[[columna]], probs = probs)
  
  tibble(
    Cuantil = paste0(names(valores)),
    Valor = as.numeric(valores)
  )
}

df_n10_esc1_DML <- tabla_cuantiles(simulaciones_DML_nbase10_1000reps)
df_n50_esc1_DML <- tabla_cuantiles(simulaciones_DML_nbase50_1000reps)
df_n100_esc1_DML <- tabla_cuantiles(simulaciones_DML_nbase100_1000reps)
df_n500_esc1_DML <- tabla_cuantiles(simulaciones_DML_nbase500_1000reps)
df_n1000_esc1_DML <- tabla_cuantiles(simulaciones_DML_nbase1000_1000reps)
df_n5000_esc1_DML <- tabla_cuantiles(simulaciones_DML_nbase5000_1000reps)
df_n10000_esc1_DML <- tabla_cuantiles(simulaciones_DML_nbase10000_1000reps)

df_n10_esc2_DML <- tabla_cuantiles(simulaciones_DML_nbase10_1000reps_esc2)
df_n50_esc2_DML <- tabla_cuantiles(simulaciones_DML_nbase50_1000reps_esc2)
df_n100_esc2_DML <- tabla_cuantiles(simulaciones_DML_nbase100_1000reps_esc2)
df_n500_esc2_DML <- tabla_cuantiles(simulaciones_DML_nbase500_1000reps_esc2)
df_n1000_esc2_DML <- tabla_cuantiles(simulaciones_DML_nbase1000_1000reps_esc2)
df_n5000_esc2_DML <- tabla_cuantiles(simulaciones_DML_nbase5000_1000reps_esc2)
df_n10000_esc2_DML <- tabla_cuantiles(simulaciones_DML_nbase10000_1000reps_esc2)

df_n10_esc3_DML <- tabla_cuantiles(simulaciones_DML_nbase10_1000reps_esc3)
df_n50_esc3_DML <- tabla_cuantiles(simulaciones_DML_nbase50_1000reps_esc3)
df_n100_esc3_DML <- tabla_cuantiles(simulaciones_DML_nbase100_1000reps_esc3)
df_n500_esc3_DML <- tabla_cuantiles(simulaciones_DML_nbase500_1000reps_esc3)
df_n1000_esc3_DML <- tabla_cuantiles(simulaciones_DML_nbase1000_1000reps_esc3)
df_n5000_esc3_DML <- tabla_cuantiles(simulaciones_DML_nbase5000_1000reps_esc3)
df_n10000_esc3_DML <- tabla_cuantiles(simulaciones_DML_nbase10000_1000reps_esc3)

df_n10_esc4_DML <- tabla_cuantiles(simulaciones_DML_nbase10_1000reps_esc4)
df_n50_esc4_DML <- tabla_cuantiles(simulaciones_DML_nbase50_1000reps_esc4)
df_n100_esc4_DML <- tabla_cuantiles(simulaciones_DML_nbase100_1000reps_esc4)
df_n500_esc4_DML <- tabla_cuantiles(simulaciones_DML_nbase500_1000reps_esc4)
df_n1000_esc4_DML <- tabla_cuantiles(simulaciones_DML_nbase1000_1000reps_esc4)
df_n5000_esc4_DML <- tabla_cuantiles(simulaciones_DML_nbase5000_1000reps_esc4)
df_n10000_esc4_DML <- tabla_cuantiles(simulaciones_DML_nbase10000_1000reps_esc4)

############ Tablas unificadas percentiles en base a n ########.

# Unificamos las tablas
tabla_percentiles_agrupada_esc <- function(
        df_n10_esc4_DML,
        df_n50_esc4_DML,
        df_n100_esc4_DML,
        df_n500_esc4_DML,
        ...
        df_n10000_esc4_DML)
  {
    # Listamos todos tus dataframes
    lista_dfs <- list(
      `10` = df_n10_esc4_DML,
      `50` = df_n50_esc4_DML,
      `100` = df_n100_esc4_DML,
      `500` = df_n500_esc4_DML,
      `1000` = df_n1000_esc4_DML,
      `5000` = df_n5000_esc4_DML,
      `10000` = df_n10000_esc4_DML
      )
    
    # Renombramos las columnas de Valor según el n en cada df
    lista_dfs <- imap(lista_dfs, ~rename(.x, !!paste0("n_", .y) := Valor))
    
    # Reduce con left_join por Cuantil
    tabla_percentiles <- reduce(lista_dfs, left_join, by = "Cuantil")
    return(tabla_percentiles)

}

# Tabla escenario 1
tabla_perc_1 <- tabla_percentiles_agrupada_esc(
    df_n10_esc1_DML,
    df_n50_esc1_DML,
    df_n100_esc1_DML,
    df_n500_esc1_DML,
...
# Tabla escenario 2
tabla_perc_2 <- tabla_percentiles_agrupada_esc(
  df_n10_esc2_DML,
  df_n50_esc2_DML,
  df_n100_esc2_DML,
  df_n500_esc2_DML,
...
# Tabla escenario 3
tabla_perc_3 <- tabla_percentiles_agrupada_esc(
  df_n10_esc3_DML,
  df_n50_esc3_DML,
  df_n100_esc3_DML,
  df_n500_esc3_DML,
...
# Tabla escenario 4
tabla_perc_4 <- tabla_percentiles_agrupada_esc(
  df_n10_esc4_DML,
  df_n50_esc4_DML,
  df_n100_esc4_DML,
  df_n500_esc4_DML,
...
### Pasamos estas tabblas al formato de overleaf ##.

tabla_percentiles_a_latex <- function(tabla, caption = "Percentiles por tamaño muestral", label = "tab:percentiles") {
  # Quita el % para que Overleaf no lo lea como comentario
  tabla <- tabla %>%
    mutate(Cuantil = gsub("%", "\\\\%", Cuantil))
  
  # Formatea los números a 3 decimales
  tabla_fmt <- tabla
  ...
  encabezado <- paste(
    ...
    "\\begin{tabular}{c", 
    paste(rep("c", ncol(tabla_fmt) - 1), collapse = ""), 
    "}", sep = "")
  
  toprule <- "\\toprule"
  colnames_fmt <- paste(colnames(tabla_fmt), collapse = " & ")
  midrule <- "\\midrule"
  
  # Filas
  filas <- apply(tabla_fmt, 1, function(row) paste(row, collapse = " & "))
  
  # Junta todo el código LaTeX
  tabla_latex <- paste0(
    encabezado, "\n",
    toprule, "\n",
    colnames_fmt, " \\\\", "\n",
  ...
  # Output
  cat(tabla_latex)
  invisible(tabla_latex)
}

tabla_percentiles_a_latex(tabla_perc_1, 
                          caption = "Percentiles estimados por tamaño muestral. Escenario 1.", 
                          label = "tab:percentiles_esc1")



################## Resultados para el overleaf ####################

# Tabla pirncipal con resultados resumidos promedio por simulación

library(readxl)
# DML
simulaciones_dml_esc1 <- read_excel("simulaciones_dml_esc1_1000casos.xlsx")
simulaciones_dml_esc2 <- read_excel("simulaciones_dml_esc2_1000casos.xlsx")
simulaciones_dml_esc3 <- read_excel("simulaciones_dml_esc3_1000casos.xlsx")
simulaciones_dml_esc4 <- read_excel("simulaciones_dml_esc4_1000casos.xlsx")

# DR paramétrico
simulaciones_dr_esc1 <- read_excel("simulaciones_dr_esc1_1000casos.xlsx")
simulaciones_dr_esc2 <- read_excel("simulaciones_dr_esc2_1000casos.xlsx")
simulaciones_dr_esc3 <- read_excel("simulaciones_dr_esc3_1000casos.xlsx")
simulaciones_dr_esc4 <- read_excel("simulaciones_dr_esc4_1000casos.xlsx")

# DR plug-in (Random Forest)
simulaciones_dr_rf_esc1 <- read_excel("simulaciones_dr_rf_esc1_1000casos.xlsx")
simulaciones_dr_rf_esc2 <- read_excel("simulaciones_dr_rf_esc2_1000casos.xlsx")
simulaciones_dr_rf_esc3 <- read_excel("simulaciones_dr_rf_esc3_1000casos.xlsx")
simulaciones_dr_rf_esc4 <- read_excel("simulaciones_dr_rf_esc4_1000casos.xlsx")



##### Aplicamos la función para las tablas de resultados #####.

# Aplicamos a los escenarios de DML
resumen_dml_esc1 <- resumen_simulaciones(simulaciones_dml_esc1, theta_0)
resumen_dml_esc2 <- resumen_simulaciones(simulaciones_dml_esc2, theta_0)
resumen_dml_esc3 <- resumen_simulaciones(simulaciones_dml_esc3, theta_0)
resumen_dml_esc4 <- resumen_simulaciones(simulaciones_dml_esc4, theta_0)

# Aplicamos a los escenarios de DR
# Agregamos primero el se porque solo tenemos el sd
simulaciones_dr_esc1$se <- simulaciones_dr_esc1$sd / sqrt(10000)
simulaciones_dr_esc2$se <- simulaciones_dr_esc2$sd / sqrt(10000)
simulaciones_dr_esc3$se <- simulaciones_dr_esc3$sd / sqrt(10000)
simulaciones_dr_esc4$se <- simulaciones_dr_esc4$sd / sqrt(10000)

resumen_dr_esc1 <- resumen_simulaciones(simulaciones_dr_esc1, theta_0)
resumen_dr_esc2 <- resumen_simulaciones(simulaciones_dr_esc2, theta_0)
resumen_dr_esc3 <- resumen_simulaciones(simulaciones_dr_esc3, theta_0)
resumen_dr_esc4 <- resumen_simulaciones(simulaciones_dr_esc4, theta_0)

# Aplicamos a los escenarios de DR con RF plug in

# Agregamos primero el se porque solo tenemos el sd
simulaciones_dr_rf_esc1$se <- simulaciones_dr_rf_esc1$sd / sqrt(10000)
simulaciones_dr_rf_esc2$se <- simulaciones_dr_rf_esc2$sd / sqrt(10000)
simulaciones_dr_rf_esc3$se <- simulaciones_dr_rf_esc3$sd / sqrt(10000)
simulaciones_dr_rf_esc4$se <- simulaciones_dr_rf_esc4$sd / sqrt(10000)

resumen_dr_rf_esc1 <- resumen_simulaciones(simulaciones_dr_rf_esc1, theta_0)
resumen_dr_rf_esc2 <- resumen_simulaciones(simulaciones_dr_rf_esc2, theta_0)
resumen_dr_rf_esc3 <- resumen_simulaciones(simulaciones_dr_rf_esc3, theta_0)
resumen_dr_rf_esc4 <- resumen_simulaciones(simulaciones_dr_rf_esc4, theta_0)

######## Tabla para latex ########

# Armamos las matrices de sesgo y rmse
sesgos <- matrix(
  c(resumen_dml_esc1$sesgo_promedio, resumen_dr_esc1$sesgo_promedio, resumen_dr_rf_esc1$sesgo_promedio,
    resumen_dml_esc2$sesgo_promedio, resumen_dr_esc2$sesgo_promedio, resumen_dr_rf_esc2$sesgo_promedio,
    resumen_dml_esc3$sesgo_promedio, resumen_dr_esc3$sesgo_promedio, resumen_dr_rf_esc3$sesgo_promedio,
    resumen_dml_esc4$sesgo_promedio, resumen_dr_esc4$sesgo_promedio, resumen_dr_rf_esc4$sesgo_promedio),
  nrow = 4, byrow = TRUE
)
colnames(sesgos) <- c("DML", "DR paramétrico", "DR plug-in ML")

# RMSE
rmses <- matrix(
  c(resumen_dml_esc1$rmse_promedio, resumen_dr_esc1$rmse_promedio, resumen_dr_rf_esc1$rmse_promedio,
    resumen_dml_esc2$rmse_promedio, resumen_dr_esc2$rmse_promedio, resumen_dr_rf_esc2$rmse_promedio,
    resumen_dml_esc3$rmse_promedio, resumen_dr_esc3$rmse_promedio, resumen_dr_rf_esc3$rmse_promedio,
    resumen_dml_esc4$rmse_promedio, resumen_dr_esc4$rmse_promedio, resumen_dr_rf_esc4$rmse_promedio),
  nrow = 4, byrow = TRUE
)
colnames(rmses) <- c("DML", "DR paramétrico", "DR plug-in ML")
